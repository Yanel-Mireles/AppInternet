...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="m-0 font-sans antialiased font-normal bg-white text-start text-base leading-default text-slate-500">
      ...
      <div class="bg-white  p-5 container mx-auto flex justify-between items-center">
        <div class="flex flex-wrap -mx-3">
          <div class="w-full max-w-full px-3 flex-0">
            <!-- {{-- Navegacion --}} -->
            @auth
            <!-- Navbar con los enlaces para las paginas-->
            <nav class="p-5 border-b shadow absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 mx-6 my-4 shadow-soft-2xl rounded-blur bg-white backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
