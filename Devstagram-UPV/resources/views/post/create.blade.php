...
@section('contenido')
    <div class="md:flex ms:items-center">
        <div class="md:w-1/2 px-10">
            imagen
            <form action="#" method="POST" enctype="multipart/form-data" id="dropzone" class="dropzone border-dashed border-2 w-full h-96 rounded flex flex-col justify-center items-center"></form>
        </div>
